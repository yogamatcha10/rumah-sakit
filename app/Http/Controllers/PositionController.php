...
class PositionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ...
            ->with('success', 'Positions has been created successfully.');
    }
    ...
    public function update(Request $request, position $position)
    {
        ...
        return redirect()
            ->route('positions.index')
            ->with('success', 'Position Has Been updated successfully');
    }
    public function destroy(Position $position)
    {
        ...
        return redirect()
            ->route('positions.index')
            ->with('success', 'Position has been deleted successfully');
    }
    public function exportExcel()
    {
        return Excel::download(new ExportPositions, 'position_rs.xlsx');
    }
}